...
leg_entry=['M_{A0}=300 GeV','M_{A0}=500 GeV']#'m_{Zp}=450 GeV','m_{Zp}=500 GeV','m_{Zp}=600 GeV','m_{Zp}=800 GeV','m_{Zp}=1000 GeV','m_{Zp}=1200 GeV']#,'ma=dhfgvsg']

ntuple = TChain("ana/anatree")
#ntuple.Add(sys.argv[1])

runs=['07','10']#'01','02','03','05','06','07']#,'04','05','06']
...
for i in runs:
    ...
    h_pt         =TH1F('h_pt','',100,0,1200)
    h_eta           =TH1F('h_eta',  '',50,-8,8)
    h_phi          =TH1F('h_phi',  '',  10,-5,5)
    h_pt_1         =TH1F('h_pt','',60,0,1200)
    h_eta_1           =TH1F('h_eta',  '',50,-8,8)
    h_phi_1         =TH1F('h_phi',  '',  10,-5,5)
    #h_mass          =TH1F('h_mass','',200,124.9999,125.0001)
    ...
    for ievent in range(NEntries):
        ...
        for i in range(len(mom0status)):
            ...
            if pdgID==22 and mom0pid[i]==25 and flag==0:#and momstatus==22 :
            ...
            elif pdgID==22 and mom0pid[i]==25 and flag==1:#and momstatus==22 :
                p4=ROOT.TLorentzVector()
                p4.SetPtEtaPhiM(genpt[i+2],geneta[i+2],genphi[i+2],genmass[i+2])
                h_pt_1.Fill(p4.Pt())
                h_eta_1.Fill(p4.Eta())
    ...
    histspt1.append(h_pt_1)
    histseta1.append(h_eta_1)
    histsphi1.append(h_phi_1)
...
gStyle.SetOptStat(0)
legend = CreateLegend(0.70, 0.94, 0.75, 0.92, "m_{Zp}=1200 GeV, m_{h}=125 GeV")

for hist in range(len(histspt)):

    if hist==0:
        histspt[hist].SetXTitle("p_{T} of #gamma1 [GeV]")
        ...
        histspt[hist].SetXTitle("pT_{#gamma} [GeV")
        histspt[hist].SetYTitle("Events")
        histspt[hist].SetMaximum(1)
        histspt[hist].SetLineColor(hist+1)
        histspt[hist].Rebin(2)
        histspt[hist].SetLineWidth(4)
        histspt[hist].Scale(1/histspt[hist].Integral())
...
texcms.Draw("same")
texCat.Draw("same")
t = ROOT.TPaveLabel(0.1, 0.96, 0.95, 0.99, "p_{T} comparison of #gamma1", "brNDC")
t.Draw('same')
c.Update()

c.SaveAs("Combined_a1_pt_Zp1200.png")
c.SaveAs("Combined_a1_pt_Zp1200.root")
...
for hist in range(len(histseta)):
    #legend = CreateLegend(0.70, 0.94, 0.75, 0.92, "M_{Zp}=1200 GeV")
    if hist==0:
        histseta[hist].SetXTitle("#eta_{#gamma1}")
...
texcms.Draw("same")
texCat.Draw("same")
t = ROOT.TPaveLabel(0.1, 0.96, 0.95, 0.99, "#eta_{#gamma1} comparison", "brNDC")
t.Draw('same')
c.Update()

c.SaveAs("Combined_a1_eta_Zp1200.png")
c.SaveAs("Combined_a1_eta_Zp1200.root")

###################################################################

legend = CreateLegend(0.80, 0.94, 0.75, 0.92, "m_{Zp}=1200 GeV, m_{h}=125 GeV")

for hist in range(len(histsphi)):
    #legend = CreateLegend(0.70, 0.94, 0.75, 0.92, "M_{Zp}=1200 GeV")
    if hist==0:
        histsphi[hist].SetXTitle("#phi_{#gamma1}")
...
texcms.Draw("same")
texCat.Draw("same")
t = ROOT.TPaveLabel(0.1, 0.96, 0.95, 0.99, "#phi_{#gamma1} comparison", "brNDC")
t.Draw('same')
c.Update()

c.SaveAs("Combined_a1_phi_Zp1200.png")
c.SaveAs("Combined_a1_phi_Zp1200.root")
...
for hist in range(len(histspt1)):

    if hist==0:
        histspt1[hist].SetXTitle("p_{T} of #gamma2 [GeV]")
        histspt1[hist].SetYTitle("Events")
        histspt[hist].SetMaximum(10)
        histspt1[hist].SetLineColor(hist+1)
        histspt[hist].Rebin(2)
        histspt1[hist].SetLineWidth(4)
        histspt1[hist].Scale(1/histspt1[hist].Integral())
        #histspt1[hist].SetLineStyle(hist+1)
        legend.AddEntry(histspt1[hist],leg_entry[hist],"L")
        histspt1[hist].Draw('hist')

    else:
        histspt1[hist].SetXTitle("pT_{#gamma2} [GeV")
        histspt1[hist].SetYTitle("Events")
        histspt[hist].SetMaximum(10)
        histspt1[hist].SetLineColor(hist+1)
        histspt[hist].Rebin(2)
...
texcms.Draw("same")
texCat.Draw("same")
t = ROOT.TPaveLabel(0.1, 0.96, 0.95, 0.99, "p_{T} comparison of #gamma2", "brNDC")
t.Draw('same')
c.Update()

c.SaveAs("Combined_a2_pt_Zp1200.png")
c.SaveAs("Combined_a2_pt_Zp1200.root")

###################################################################

legend = CreateLegend(0.70, 0.94, 0.75, 0.92, "m_{Zp}=1200 GeV, m_{h}=125 GeV")

for hist in range(len(histseta1)):
    #legend = CreateLegend(0.70, 0.94, 0.75, 0.92, "M_{Zp}=1200 GeV")
    if hist==0:
        histseta1[hist].SetXTitle("#eta_{#gamma2}")
        histseta1[hist].SetYTitle("Events")
        histseta1[hist].SetLineColor(hist+1)
        histseta1[hist].SetLineWidth(4)
        histseta1[hist].Scale(1/histseta1[hist].Integral())
        #histseta1[hist].SetLineStyle(hist+1)
        legend.AddEntry(histseta1[hist],leg_entry[hist],"L")
        #legend.AddEntry(histseta[hist],"run_0"+str(hist+1),"L")
        histseta1[hist].Draw('hist')
...
texcms.Draw("same")
texCat.Draw("same")
t = ROOT.TPaveLabel(0.1, 0.96, 0.95, 0.99, "#eta_{#gamma2} comparison", "brNDC")
t.Draw('same')
c.Update()

c.SaveAs("Combined_a2_eta_Zp1200.png")
c.SaveAs("Combined_a2_eta_Zp1200.root")

###################################################################

legend = CreateLegend(0.80, 0.94, 0.75, 0.92, "m_{Zp}=1200 GeV, m_{h}=125 GeV")

for hist in range(len(histsphi1)):
    #legend = CreateLegend(0.70, 0.94, 0.75, 0.92, "M_{Zp}=1200 GeV")
    if hist==0:
        histsphi1[hist].SetXTitle("#phi_{#gamma2}")
        histsphi1[hist].SetYTitle("Events")
        histsphi1[hist].SetLineColor(hist+1)
        histsphi1[hist].SetLineWidth(4)
        histsphi1[hist].Scale(1/histsphi1[hist].Integral())
        #histsphi1[hist].SetLineStyle(hist+1)
        legend.AddEntry(histsphi1[hist],leg_entry[hist],"L")
        histsphi1[hist].Draw('hist')

    else:
        histsphi1[hist].SetXTitle("#phi_{#gamma1}")
        histsphi1[hist].SetYTitle("Events")
        histsphi1[hist].SetLineColor(hist+1)
        histsphi1[hist].SetLineWidth(4)
        histsphi1[hist].Scale(1/histsphi1[hist].Integral())
...
texcms.Draw("same")
texCat.Draw("same")
t = ROOT.TPaveLabel(0.1, 0.96, 0.95, 0.99, "#phi_{#gamma2} comparison", "brNDC")
t.Draw('same')
c.Update()

c.SaveAs("Combined_a2_phi_Zp1200.png")
c.SaveAs("Combined_a2_phi_Zp1200.root")
