...
for i in runs:
    ...
    for ievent in range(NEntries):
        ...
        for i in range(len(mom0status)):
            ...
            if (pdgID==5) and mom0pid[i]==28 :#and momstatus==22:
            ...
            elif pdgID==-5 and mom0pid[i]==28 :#and momstatus==22:
                p4=ROOT.TLorentzVector()
                p4.SetPtEtaPhiM(genpt[i+2],geneta[i+2],genphi[i+2],genmass[i+2])
                h_pt_1.Fill(p4.Pt())
                h_eta_1.Fill(p4.Eta())
...
for hist in range(len(histspt)):
    ...
    if hist==0:
        ...
        histspt[hist].SetXTitle("pT_{b} [GeV")
        histspt[hist].SetYTitle("Events")
        histspt[hist].SetMaximum(1)
        histspt[hist].SetLineColor(hist+1)
        histspt[hist].Rebin(4)
...
texcms.Draw("same")
texCat.Draw("same")
t = ROOT.TPaveLabel(0.1, 0.96, 0.95, 0.99, "p_{T} comparison of b", "brNDC")
t.Draw('same')
c.Update()

c.SaveAs("Combined_b_pt_Zp1200.png")
c.SaveAs("Combined_b_pt_Zp1200.root")
...
for hist in range(len(histseta)):
    ...
    if hist==0:
        histseta[hist].SetXTitle("#eta_{b}")
...
texcms.Draw("same")
texCat.Draw("same")
t = ROOT.TPaveLabel(0.1, 0.96, 0.95, 0.99, "#eta_{b} comparison", "brNDC")
t.Draw('same')
c.Update()

c.SaveAs("Combined_b_eta_Zp1200.png")
c.SaveAs("Combined_b_eta_Zp1200.root")
...
for hist in range(len(histsphi)):
    #legend = CreateLegend(0.70, 0.94, 0.75, 0.92, "M_{Zp}=1200 GeV")
    if hist==0:
        histsphi[hist].SetXTitle("#phi_{b}")
...
texcms.Draw("same")
texCat.Draw("same")
t = ROOT.TPaveLabel(0.1, 0.96, 0.95, 0.99, "#phi_{b} comparison", "brNDC")
t.Draw('same')
c.Update()

c.SaveAs("Combined_b_phi_Zp1200.png")
c.SaveAs("Combined_b_phi_Zp1200.root")
...
for hist in range(len(histspt1)):
    ...
    if hist==0:
        ...
        histspt1[hist].SetXTitle("pT_{b~} [GeV")
        histspt1[hist].SetYTitle("Events")
        histspt[hist].SetMaximum(1)
        histspt1[hist].SetLineColor(hist+1)
        histspt1[hist].Rebin(4)
...
c.SaveAs("Combined_bbar_pt_Zp1200.png")
c.SaveAs("Combined_bbar_pt_Zp1200.root")
...
for hist in range(len(histseta1)):
    #legend = CreateLegend(0.70, 0.94, 0.75, 0.92, "M_{Zp}=1200 GeV")
    if hist==0:
        histseta1[hist].SetXTitle("#eta_{b~}")
...
c.SaveAs("Combined_bbar_eta_Zp1200.png")
c.SaveAs("Combined_bbar_eta_Zp1200.root")
...
for hist in range(len(histsphi1)):
    #legend = CreateLegend(0.70, 0.94, 0.75, 0.92, "M_{Zp}=1200 GeV")
    if hist==0:
        histsphi1[hist].SetXTitle("#phi_{b~}")
...
c.SaveAs("Combined_bbar_phi_Zp1200.png")
c.SaveAs("Combined_bbar_phi_Zp1200.root")
